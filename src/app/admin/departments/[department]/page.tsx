    ...
    setSubjectForm({
      ...
      typicalSemester:
        ...
        subject.typicalSemester !== null
          ...
          : "",
      note: subject.note ?? "",
      curriculumYear: String(subject.curriculumYear ?? CURRENT_CURRICULUM_YEAR),
    });
    setShowForm(true);
  }
    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify({
          ...
          curriculumYear: subjectForm.curriculumYear
            ? Number(subjectForm.curriculumYear)
          ...
          <tbody>
            {department.subjects.map((subject) => (
              ...
              >
                ...
                >
                  {subject.curriculumYear ?? CURRENT_CURRICULUM_YEAR}
                </td>
        ...
        >
          ...
          >
            ...
            <input
              ...
              value={subjectForm.curriculumYear}
              onChange={(e) =>
                setSubjectForm({
                  ...subjectForm,
            ...
            <p style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: 4 }}>
              Batches admitted in this year or later automatically use this subject,
              until a newer curriculum year is added for the same slot.
            </p>
